...
public class CourseDto {
    ...
    public CourseDto(String course_id, String title, int cred_hrs, int max_enrollcap, String department_id) {
    ...
    public String toString() {
        return "CourseDto [course_id=" + course_id + ", title=" + title + ", cred_hrs=" + cred_hrs + ", max_enrollcap="
                + max_enrollcap + ", department_id=" + department_id + "]";
    }
}
