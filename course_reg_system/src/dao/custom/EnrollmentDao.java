...
public interface EnrollmentDao extends CrudDao<EnrollmentEntity, String> {
    ...
    ArrayList<EnrollmentEntity> searchByCourseIdCurrentlyFollowing(String courseId) throws Exception;
    ArrayList<EnrollmentEntity> searchByCourseIdCompleted(String courseId) throws Exception;
}
